  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<AcceptedDetailsViewModel>.reactive(
      ...
      builder: (_, model, child) {
        return Scaffold(
          appBar: AppBar(
            title: Text(acceptedServiceData.name),
          ),
          body: SafeArea(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ProfileInfoWidget(
                            ...
                            value: model.model.paymentStatus.toUpperCase(),
                          ),
                          SizedBox(height: 10.h),
                          ProfileInfoWidget(
                            title: 'Service Status:',
                            value: model.model.serviceStatus.toUpperCase(),
                          ),
                        ],
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ProfileInfoWidget(
                            title: 'Consumer Name:',
                            value: model.model.orderAddress?.orderName ?? '',
                          ),
                          SizedBox(height: 10.h),
                          Row(
                            children: [
                              Expanded(
                                child: ProfileInfoWidget(
                                  title: 'Mobile:',
                                  value: model.model.orderAddress?.mobile ?? '',
                                ),
                              ),
                              SizedBox(width: 5.w),
                              IconButton(
                          ...
                          ProfileInfoWidget(
                            title: 'Mobile:',
                            value: model.model.orderAddress?.address ?? '',
                          ),
                          SizedBox(height: 10.h),
                          Stack(
                            children: [
